...
def BFSVisit(start,end):
  start,end = allActors[start],allActors[end]  #start is a actor object
  visited,queue  =[],[[start]] #queue is a list of path, path is a list of node/actor obj
